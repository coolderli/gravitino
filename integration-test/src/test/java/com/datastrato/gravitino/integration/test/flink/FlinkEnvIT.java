 ...
 */
package com.datastrato.gravitino.integration.test.flink;
...
public abstract class FlinkEnvIT extends AbstractIT {
  ...
  private static void initFlinkEnv() {
    ...
    configuration.setString("table.catalog-store.gravitino.metalakeName", metalakeName);
    configuration.setString("table.catalog-store.gravitino.metalakeUri", gravitinoUri);
