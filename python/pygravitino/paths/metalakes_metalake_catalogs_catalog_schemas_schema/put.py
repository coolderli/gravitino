...
# body param
SchemaForRequestBodyApplicationJson = SchemaUpdatesRequest


request_body_schema_updates_request = api_client.RequestBody(
    content={
...
class SchemaFor200ResponseBodyApplicationVndGravitinoV1json(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["schema"]) -> 'Schema': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "schema", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["schema"]) -> typing.Union['Schema', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "schema", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        schema: typing.Union['Schema', schemas.Unset] = schemas.unset,
...
class BaseApi(api_client.Api):
    ...
    def _alter_schema_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_schema_updates_request.serialize(body, content_type)
...
class AlterSchema(BaseApi):
    ...
    def alter_schema(
        ...
        return self._alter_schema_oapg(
            body=body,
