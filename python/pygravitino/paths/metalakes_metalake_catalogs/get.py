...
class SchemaFor200ResponseBodyApplicationVndGravitinoV1json(
        ...
        class properties:
            ...
            class identifiers(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['NameIdentifier']:
                        return NameIdentifier
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['NameIdentifier'], typing.List['NameIdentifier']],
                ...
                def __getitem__(self, i: int) -> 'NameIdentifier':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "identifiers", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "identifiers", ], str]):
...
class ListCatalogs(BaseApi):
    ...
    def list_catalogs(
        ...
        return self._list_catalogs_oapg(
