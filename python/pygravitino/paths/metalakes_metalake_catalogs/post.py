...
# body param
SchemaForRequestBodyApplicationJson = CatalogCreateRequest


request_body_catalog_create_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_catalog_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_catalog_create_request.serialize(body, content_type)
