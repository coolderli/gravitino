...
# body param
SchemaForRequestBodyApplicationJson = TableCreateRequest


request_body_table_create_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_table_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_table_create_request.serialize(body, content_type)
...
class CreateTable(BaseApi):
    ...
    def create_table(
        ...
        return self._create_table_oapg(
            body=body,
