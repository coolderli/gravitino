...
# body param
SchemaForRequestBodyApplicationJson = SchemaCreateRequest


request_body_schema_create_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_schema_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_schema_create_request.serialize(body, content_type)
...
class CreateSchema(BaseApi):
    ...
    def create_schema(
        ...
        return self._create_schema_oapg(
            body=body,
