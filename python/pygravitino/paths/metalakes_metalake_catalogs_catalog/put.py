...
# body param
SchemaForRequestBodyApplicationJson = CatalogUpdatesRequest


request_body_catalog_updates_request = api_client.RequestBody(
    content={
...
class SchemaFor200ResponseBodyApplicationVndGravitinoV1json(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "catalog", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "catalog", ], str]):
...
class BaseApi(api_client.Api):
    ...
    def _alter_catalog_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_catalog_updates_request.serialize(body, content_type)
...
class AlterCatalog(BaseApi):
    ...
    def alter_catalog(
        ...
        return self._alter_catalog_oapg(
            body=body,
