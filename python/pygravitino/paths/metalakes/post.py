...
# body param
SchemaForRequestBodyApplicationJson = MetalakeCreateRequest


request_body_metalake_create_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_metalake_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_metalake_create_request.serialize(body, content_type)
...
class CreateMetalake(BaseApi):
    ...
    def create_metalake(
        ...
        return self._create_metalake_oapg(
            body=body,
