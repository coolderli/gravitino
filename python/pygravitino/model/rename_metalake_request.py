...
class RenameMetalakeRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["@type", "newName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["@type", "newName", ], str]):
