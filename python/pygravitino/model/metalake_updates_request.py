        ...
        class properties:
            ...
            class updates(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MetalakeUpdateRequest']:
                        return MetalakeUpdateRequest
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['MetalakeUpdateRequest'], typing.List['MetalakeUpdateRequest']],
                ...
                def __getitem__(self, i: int) -> 'MetalakeUpdateRequest':
