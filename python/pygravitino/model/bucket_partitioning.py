...
class BucketPartitioning(
    ...
    numBuckets: MetaOapg.properties.numBuckets
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["strategy"]) -> MetaOapg.properties.strategy: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["numBuckets"]) -> MetaOapg.properties.numBuckets: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["strategy", "numBuckets", "fieldNames", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["numBuckets"]) -> MetaOapg.properties.numBuckets: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["strategy", "numBuckets", "fieldNames", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        numBuckets: typing.Union[MetaOapg.properties.numBuckets, decimal.Decimal, int, ],
