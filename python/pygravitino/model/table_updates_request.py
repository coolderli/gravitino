        ...
        class properties:
            ...
            class updates(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TableUpdateRequest']:
                        return TableUpdateRequest
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['TableUpdateRequest'], typing.List['TableUpdateRequest']],
                ...
                def __getitem__(self, i: int) -> 'TableUpdateRequest':
