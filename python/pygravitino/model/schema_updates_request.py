        ...
        class properties:
            ...
            class updates(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SchemaUpdateRequest']:
                        return SchemaUpdateRequest
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['SchemaUpdateRequest'], typing.List['SchemaUpdateRequest']],
                ...
                def __getitem__(self, i: int) -> 'SchemaUpdateRequest':
