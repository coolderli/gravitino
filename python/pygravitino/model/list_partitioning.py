...
class ListPartitioning(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["strategy", "fieldNames", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["strategy", "fieldNames", ], str]):
