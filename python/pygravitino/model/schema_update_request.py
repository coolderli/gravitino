...
class SchemaUpdateRequest(
    ...
    class MetaOapg:
        ...
        def discriminator():
            return {
                '@type': {
                    'RemoveSchemaPropertyRequest': RemoveSchemaPropertyRequest,
                    'SetSchemaPropertyRequest': SetSchemaPropertyRequest,
                    'removeProperty': RemoveSchemaPropertyRequest,
                    'setProperty': SetSchemaPropertyRequest,
                }
            }
