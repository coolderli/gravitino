...
class TruncatePartitioning(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["strategy", "width", "fieldName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["strategy", "width", "fieldName", ], str]):
